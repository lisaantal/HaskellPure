...
#[derive(Debug)]
pub struct HaskellPureProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HaskellPureProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HaskellPure processing");
    
    let mut processor = HaskellPureProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HaskellPureProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HaskellPureProcessor::new(false);
